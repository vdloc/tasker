...
export default function SlidePopUp() {
  const isOpen = useStore((state) => state.isTaskUpdatePopupOpen);
  ...
  return (
    <Transition.Root show={isOpen} as={Fragment}>
      <Dialog
        as="div"
        className="fixed w-screen h-screen top-0 left-0 bg-indigo-400 opacity-40"
        onClose={toggleTaskUpdatePopup}
      >
        <div className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 w-[25rem] h-[700px] overflow-auto">
          <Transition.Child
            as={Fragment}
            enter="transform transition ease-in-out duration-300 sm:duration-700"
            enterFrom="translate-x-0 opacity-0"
            enterTo="translate-x-[calc(100% + 5rem)] opacity-1"
            leave="transform transition ease-in-out duration-300 sm:duration-700"
            leaveFrom="translate-x-[calc(100% + 5rem)] opacity-1"
                        ...
                        <div>
                          ...
                          <div className="mt-1">
                            <input
                              ...
                              name="project-name"
                              id="project-name"
                              className="block w-full h-8 rounded-md border border-gray-900 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                            />
                          </div>
                        </div>
                        <div>
                          ...
                          <div className="mt-1">
                            <textarea
                              ...
                              name="description"
                              rows={4}
                              className="block w-full rounded-md border border-gray-900 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                              defaultValue={""}
                            />
                          </div>
                        </div>
