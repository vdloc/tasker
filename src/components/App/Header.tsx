...
export default function AppHeader() {
  ...
  return (
    <div className="border-b border-gray-200 bg-transparent px-4 h-20 md:h-28 grid items-center">
      <div className="-ml-4 -mt-4 flex flex-wrap items-center justify-between md:flex-nowrap">
        <div className="ml-4 mt-4">
          <h3 className="text-2xl font-medium leading-6 text-gray-900 dark:text-gray-100 text-left">{name}</h3>
          <p className="mt-2 text-sm text-gray-500 dark:text-gray-100 italic font-medium">{description}</p>
        </div>
